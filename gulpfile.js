...
gulp.task('copywp', function(){
  gulp.src('./public/css/**')
    .pipe(gulp.dest('./wp-content/themes/revista/css'))
  gulp.src('./public/js/**')
    .pipe(gulp.dest('./wp-content/themes/revista/js'))
  gulp.src('./public/images/**')
    .pipe(gulp.dest('./wp-content/themes/revista/images'))
  gulp.src('./public/fonts/**')
    .pipe(gulp.dest('./wp-content/themes/revista/fonts'))
})
...
gulp.task('cleanwp', function(){
  return gulp.src([
    'wp-content/themes/revista/js/app.min.js',
    'wp-content/themes/revista/js/vendor.min.js',
    'wp-content/themes/revista/images',
    'wp-content/themes/revista/fonts',
    'wp-content/themes/revista/css/style.min.css',
    ], {read: false})
    .pipe(clean())
})
